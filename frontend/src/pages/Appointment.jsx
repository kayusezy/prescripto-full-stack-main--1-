...
const Appointment = () => {
    ...
    const [docInfo, setDocInfo] = useState(null) // Initialize as null instead of false
    ...
    const getAvailableSlots = useCallback(async () => {
        ...
        for (let i = 0; i < 7; i++) {
            ...
            while (currentDate < endTime) {
                ...
                // Added safe optional chaining (?.) for slots_booked protection
                const isSlotAvailable = docInfo.slots_booked?.[slotDate]?.includes(slotTimeStr) ? false : true
